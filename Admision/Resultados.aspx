<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Resultados.aspx.cs" Inherits="Admision_Resultados" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-3 order-lg-2">
                    <div style="text-align: justify">                    
                        ...
                        <br />
                        <p class="MsoNormal">
                            Los resultados de Ex&aacute;menes de Admisi&oacute;n 2022-3, ser&aacute;n el pr&oacute;ximo
                        </p>
                        <br />
                        <div class="text-center">
                            <h2 style="color:#ba6022;">12 de Agosto de 2022</h2>
                        </div>
                        <hr>
                        <video preload="auto" src="/assets/Videos/Consulta_Resultados.mp4" autoplay width=100% controls>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="/Admision/Curso_Induccion.aspx.aspx"><li class="border ps-2">Curso de Inducción</li></a>
                            <a href="/Admision/Examenes.aspx"><li class="border ps-2">Ex&aacute;menes</li></a>
                            <a href="/Admision/Resultados.aspx"><li class="border ps-2 bg-light" style="color: black !important; border-bottom-style: dashed; border-width: 1px;"><b>Resultados</b></li></a>
                        </ul>
                    </div>
