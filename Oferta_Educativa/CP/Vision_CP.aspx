<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vision_CP.aspx.cs" Inherits="Vision_CP" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href ="Vision_CP.aspx"><li class="border ps-2 bg-light"><b>Visi&oacute;n</b></li> </a>
