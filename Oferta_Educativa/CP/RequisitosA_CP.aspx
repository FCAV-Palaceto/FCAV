<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RequisitosA_CP.aspx.cs" Inherits="RequsitosA_CP" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="RequisitosA_CP.aspx"><li class="border ps-2 bg-light"><b>Requisitos Acad&eacute;micos</b></li> </a>
