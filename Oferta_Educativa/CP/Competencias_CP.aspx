<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Competencias_CP.aspx.cs" Inherits="Competencias_CP" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <p class="MsoNormal">
                            <u>Contable</u>
                            <br>
                            Define implementar un Sistema Contable con la capacidad de producir informaci&oacute;n para elaborar los estados financieros de las organizaciones que le permita participar en las decisiones, con un sentido de responsabilidad social y visi&oacute;n integradora.
                            <br><br>
                            <u>Fiscal</u>
                            <br>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            <a href="Mision_CP.aspx"><li class="border ps-2">Misi&oacute;n</li> </a> 
                            <a href ="Vision_CP.aspx"><li class="border ps-2">Visi&oacute;n</li> </a>
                            <a href="Competencias_CP.aspx"><li class="border ps-2 bg-light"><b>Competencias</b></li> </a>
                            ...
                            <a href="Curricula_CP.aspx"><li class="border ps-2">Plan de estudios</li> </a>
                        </ul>
                    </div>
