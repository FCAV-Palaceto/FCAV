<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VyA_CP.aspx.cs" Inherits="VyA_CP" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="VyA_CP.aspx"><li class="border ps-2 bg-light"><b>Valores y Actitudes</b></li> </a>
