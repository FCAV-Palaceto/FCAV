<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DocumentacionN_CP.aspx.cs" Inherits="DocumentacionN_CP" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="DocumentacionN_CP.aspx"><li class="border ps-2 bg-light"><b>Documentaci&oacute;n Necesaria</b></li> </a>
