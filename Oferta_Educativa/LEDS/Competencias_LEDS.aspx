<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Competencias_LEDS.aspx.cs" Inherits="Competencias_LEDS" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="Competencias_LEDS.aspx"><li class="border ps-2 bg-light"><b>Competencias</b></li> </a>
