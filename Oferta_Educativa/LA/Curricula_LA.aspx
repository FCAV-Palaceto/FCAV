<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Curricula_LA.aspx.cs" Inherits="Curricula_LA" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>Evolución de la Administración</td>
                                    <td>Administración General</td>
                                    <td>Consultoría de Procesos</td>
                                    <td>Administración de Organismos Públicos</td>
                                    <td>Enfoques Modernos de Administración</td>
                                    <td>Administración Internacional</td>
                                    <td>Administración Estratégica</td>
                                    <td>Administración de Pequeñas y Medianas Empresas</td>
                                ...
                                <tr>
                                    ...
                                    <td>Sistemas de Evaluación Estratégica y Financiera</td>
                                    <td>Emprendedores</td>
                                    <td>Administración total de la calidad</td>
                                </tr>
                                <tr>
                                    <td>Desarrollo de Habilidades para Aprender</td>
                                    <td>Psicología de las Organizaciones</td>
                                    <td>Comportamiento Humano en el Trabajo</td>
                                    <td>Mercadotecnia</td>
                                    <td>Administración de Personal</td>
                                    <td>Contabilidad General</td>
                                    <td>Estrategias de Publicidad y Venta</td>
                                    <td>Administración Financiera</td>
                                    <td>Mercadotecnia Aplicada</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Reingeniería de Procesos</td>
                                    <td>Logística y Suministros</td>
                                    <td>Optativa IV</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Estadística</td>
                                    <td>Habilidades de Negociación Internacional</td>
                                ...
                                <tr>
                                    ...
                                    <td>Software Administrativo y de Seguridad Social</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td>Sistemas de Información General</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td>Econometría</td>
                    ...
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            <a href="Mision_LA.aspx"><li class="border ps-2 bg-light">Misi&oacute;n</b></li></a> 
