<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="perfilEgreso_LA.aspx.cs" Inherits="Oferta_Educativa_LA_perfilEgreso_LA" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <p>Es un profesionista competente para promover el desarrollo de organismos públicos y privados, a fin de que estos operen con mayor productividad y competitividad en un entorno cambiante y globalizado, mediante el diseño y operación de sistemas en las áreas de administración estratégica, finanzas, capital humano, mercadotecnia y gestión de calidad y productividad, ejerciendo sus funciones con apego a los valores institucionales y a los códigos de ética.</p>
                    </div>
                </div> 
                    ...
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="perfilEgreso_LA.aspx"><li class="border ps-2 bg-light"><b>Perfil de Egreso</b></li> </a>
