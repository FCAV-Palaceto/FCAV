<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RequisitosA_LA.aspx.cs" Inherits="RequisitosA_LA" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="RequisitosA_LA.aspx"><li class="border ps-2 bg-light"><b>Requisitos Acad&eacute;micos</b></li> </a>
