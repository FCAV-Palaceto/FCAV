<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="perfilIngreso_LA.aspx.cs" Inherits="Oferta_Educativa_LA_perfilIngreso_LA" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <li>Inclinación al estudio de disciplinas económicas-administrativas orientadas a resolver problemas de organismos públicos y privados.</li>
                        <li>Capacidad de análisis, síntesis y evaluación de la información relacionada con su carrera.</li>
                        <li>Vocación de trabajar en equipo y adquirir conocimientos y habilidades mediante el autoaprendizaje.</li>
                        <li>Comportamiento personal con apego a principios éticos.</li>
                        <li>Hábitos de estudio ordenados y metódicos.</li>
                        <li>Convicción firme de retribuir a la sociedad los beneficios que de esta recibe.</li>
                    </div>
                </div> 
                    <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            <a href="Mision_LA.aspx"><li class="border ps-2 bg-light"><b>Misi&oacute;n</b></li></a> 
                            ...
                            <a href="Objetivos_LA.aspx"><li class="border ps-2">Objetivo</li> </a>
                            <a href="VyA_LA.aspx"><li class="border ps-2">Valores y Actitudes</li> </a>
                            <a href="perfilIngreso_LA.aspx"><li class="border ps-2 bg-light"><b>Perfil de Ingreso</b></li> </a>
