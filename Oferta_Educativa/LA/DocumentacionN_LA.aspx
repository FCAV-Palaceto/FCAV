<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DocumentacionN_LA.aspx.cs" Inherits="DocumentacionN_LA" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="DocumentacionN_LA.aspx"><li class="border ps-2 bg-light"><b>Documentaci&oacute;n Necesaria</b></li> </a>
