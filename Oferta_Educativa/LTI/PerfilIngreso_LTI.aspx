<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PerfilIngreso_LTI.aspx.cs" Inherits="RequisitosA" %>
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="PerfilIngreso_LTI.aspx"><li class="border ps-2 bg-light"><b>Perfil de Ingreso</b></li> </a>
