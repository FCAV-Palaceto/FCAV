<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Objetivos_LTI.aspx.cs" Inherits="Objetivos_LTI" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <p class="MsoNormal">
                        Formar profesionistas en las áreas de desarrollo de aplicaciones inform&aacute;ticas, gesti&oacute;n de recursos inform&aacute;ticos, infraestructura tecnol&oacute;gica, tratamiento y organizaci&oacute;n de los datos, que contribuyan a mejorar, transformar e innovar los procesos organizacionales y administrativos mediante la aplicaci&oacute;n innovadora de las tecnolog&iacute;as de informaci&oacute;n y comunicaci&oacute;n en la soluci&oacute;n de necesidades y atenci&oacute;n de oportunidades de las organizaciones, con visi&oacute;n y liderazgo ante los cambios tecnol&oacute;gicos para enfrentar exitosamente los retos que plantea la globalizaci&oacute;n con valores y actitud responsable.
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="Objetivos_LTI.aspx"><li class="border ps-2 bg-light"><b>Objetivo</b></li> </a>
