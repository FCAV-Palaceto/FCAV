<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Mision_LTI.aspx.cs" Inherits="Mision_LTI" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            <a href="Mision_LTI.aspx"><li class="border ps-2 bg-light"><b>Misi&oacute;n</b></li></a> 
