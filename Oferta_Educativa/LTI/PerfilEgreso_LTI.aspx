<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PerfilEgreso_LTI.aspx.cs" Inherits="PerfilEgreso_LTI" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;"><div class="text-end">
                    ...
                    <div style="text-align: justify">                    
                        ...
                        <p class="MsoNormal">
                            Es un profesionista competente que tiene conocimientos especializados en las tecnolog&iacute;as de informaci&oacute;n y comunicaci&oacute;n que analiza, desarrolla e integra soluciones innovadoras para la transformaci&oacute;n de los procesos de cualquier organizaci&oacute;n con visi&oacute;n, liderazgo y valores.
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                        <ul class="border">
                            ...
                            <a href="PerfilEgreso_LTI.aspx"><li class="border ps-2 bg-light"><b>Perfil de Egreso</b></li> </a>
