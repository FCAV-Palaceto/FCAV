<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Taller_Computo.aspx.cs" Inherits="Taller_Computo" %>
            ...
            <div class="row">
                <div id="lics" class="col-lg-2 content">
                    <ul class="text-end pags lisnrg">
                        ...
                        <a href="Taller_Computo.aspx"><li class="logo bg-light px-2 pb-0" style="color:black !important; border-bottom-style:dashed; border-width: 1px;"><b>Taller de Redes y Mantenimiento de C&oacute;mputo</b></li></a>
                    </ul>
                </div>
                ...
                <div class="col-lg-7 content" style="margin-bottom: 40px;">
                    ...
                    <hr>
                    <h3>Taller de Redes y Mantenimiento de C&oacute;mputo</h3>   
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="imgs/Taller-1.jpg" class="d-block w-100" alt="Taller 1-1">
                          ...
                          <div class="carousel-item">
                            <img src="imgs/taller-2.jpg" class="d-block w-100" alt="Taller 1-2">
                            <div class="carousel-caption">
                              <h5>Taller</h5>
