<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ANFECA.aspx.cs" Inherits="ANFECA" %>
            ...
            <div class="row">
                <div id="lics" class="col-lg-2 content">
                    <ul class="text-end pags lisnrg">
                        ...
                        <a href="ANFECA.aspx"><li class="logo bg-light px-2 pb-0" style="color:black !important; border-bottom-style:dashed; border-width: 1px;"><b>Sala de videoconferencia</b></li></a>
                ...
                <div class="col-lg-7 content" style="margin-bottom: 40px;">
                    ...
                    <hr>
                    <h3>Sala de videoconferencia</h3>   
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="imgs/anfeca-1.jpg" class="d-block w-100" alt="ANFECA 1">
                          ...
                          <div class="carousel-item">
                            <img src="imgs/anfeca-2.jpg" class="d-block w-100" alt="ANFECA 2">
                            <div class="carousel-caption">
                              <h5>ANFECA</h5>
                          ...
                          <div class="carousel-item">
                            <img src="imgs/anfeca-3.jpg" class="d-block w-100" alt="ANFECA 3">                        
                            <div class="carousel-caption">
                              <h5>ANFECA</h5>
                          ...
                          <div class="carousel-item">
                            <img src="imgs/anfeca-4.jpg" class="d-block w-100" alt="ANFECA 4">                        
                            <div class="carousel-caption">
                              <h5>ANFECA</h5>
