<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Salones.aspx.cs" Inherits="Salones" %>
            ...
            <div class="row">
                <div id="lics" class="col-lg-2 content">
                    <ul class="text-end pags lisnrg">
                        ...
                        <a href="Salones.aspx"><li class="logo bg-light px-2 pb-0" style="color:black !important; border-bottom-style:dashed; border-width: 1px;"><b>Salones</b></li></a>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="imgs/salon-1.jpg" class="d-block w-100" alt="Salón 1-2">
                            <div class="carousel-caption">
                              <h5>Salón licenciatura</h5>
                              <!-- <p>Some representative placeholder content for the first slide.</p> -->
                            </div>
                          </div>
                          <div class="carousel-item">
                            <img src="imgs/salon-2.jpg" class="d-block w-100" alt="Salón 1-2">
                            <div class="carousel-caption">
                              <h5>Salón licenciatura</h5>
                          ...
                          <div class="carousel-item">
                            <img src="imgs/audio-1.jpg" class="d-block w-100" alt="Salón 2-1">  
                            <div class="carousel-caption">
                              <h5>Salón audiovisual</h5>
                              <!-- <p>Some representative placeholder content for the third slide.</p> -->
                            </div>
                          </div>
                          <div class="carousel-item">
                            <img src="imgs/Audio-2.jpg" class="d-block w-100" alt="Salón 2-2">                        
                            <div class="carousel-caption">
                              <h5>Salón audiovisual</h5>
